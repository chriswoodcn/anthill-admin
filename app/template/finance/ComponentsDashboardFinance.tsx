        ...
        <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
          ...
          <div>
            <div className="mb-5 flex items-center font-bold">
              ...
              <button
                type="button"
                className="text-primary hover:text-black ltr:ml-auto rtl:mr-auto dark:hover:text-white-dark"
              >
                See All
              </button>
            </div>
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="text-center">
                      <span className="badge rounded-full bg-success/20 text-success hover:top-0">
                        Completed
                      </span>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>$1,828.16</td>
                    <td className="text-center">
                      <span className="badge rounded-full bg-danger/20 text-danger hover:top-0">
                        Pending
                      </span>
                    </td>
                  </tr>
