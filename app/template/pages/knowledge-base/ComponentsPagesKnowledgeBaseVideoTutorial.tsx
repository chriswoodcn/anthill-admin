...
const ComponentsPagesKnowledgeBaseVideoTutorial = () => {
  ...
  const items = [
    {
      src: "/assets/images/template/knowledge/image-5.jpg",
      title: "Excessive sugar is harmful",
    },
    {
      src: "/assets/images/template/knowledge/image-6.jpg",
      title: "Creative Photography",
    },
    {
      src: "/assets/images/template/knowledge/image-7.jpg",
      title: "Plan your next trip",
    },
    {
      src: "/assets/images/template/knowledge/image-8.jpg",
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4">
          {items.map((item: any, i) => {
            return (
              <div
                key={i}
                className="space-y-5 rounded-md border border-white-7 bg-white p-5 shadow-[0px_0px_2px_0px_rgba(145,158,171,0.20),0px_12px_24px_-4px_rgba(145,158,171,0.12)] dark:border-[#1B2E4B] dark:bg-black"
              >
                  ...
                  <Dialog.Panel className="my-8 w-full max-w-3xl overflow-hidden">
                    <div className="text-right">
                      <button
                        ...
                        type="button"
                        className="text-white-dark !outline-none hover:text-dark"
                      >
                        <IconX />
                      </button>
                    </div>
