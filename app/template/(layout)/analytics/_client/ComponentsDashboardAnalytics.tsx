          ...
          <div className="panel h-full">
            <div className="-m-5 mb-5 flex items-center  justify-between border-b border-white-light p-5 dark:border-black-7">
              <div className="flex">
                <div className="media-aside align-self-start">
                  <div className="shrink-0 rounded-full ring-2 ring-white-light ltr:mr-4 rtl:ml-4 dark:ring-dark">
                    <Image
                      src="/assets/images/product/g-8.png"
                      alt="profile2"
                      className="h-10 w-10 rounded-full object-cover"
                    />
                  </div>
            ...
            <div className="pb-8 text-center font-semibold">
              ...
              <div className="flex items-center justify-center gap-3 pb-8">
                ...
                <Image
                  className="h-10 w-10 overflow-hidden rounded-lg object-cover ring-2 ring-white-light dark:ring-dark"
                  src="/assets/images/profile/profile-2.jpeg"
                  alt="profile2"
                />
                <Image
                  className="h-10 w-10 overflow-hidden rounded-lg object-cover ring-2 ring-white-light dark:ring-dark"
                  src="/assets/images/profile/profile-3.jpeg"
                  alt="profile3"
                />
                <Image
                  className="h-10 w-10 overflow-hidden rounded-lg object-cover ring-2 ring-white-light dark:ring-dark"
                  src="/assets/images/profile/profile-4.jpeg"
                  alt="profile4"
                />
              </div>
