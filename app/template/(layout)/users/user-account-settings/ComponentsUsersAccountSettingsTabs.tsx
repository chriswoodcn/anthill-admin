...
const ComponentsUsersAccountSettingsTabs = () => {
  ...
  return (
    <div className="pt-5 text-black-7 dark:text-white-7">
      ...
      <div>
        <ul className="mb-5 overflow-y-auto whitespace-nowrap border-b bg-white dark:bg-black-8 border-white-8 font-semibold dark:border-black-7 sm:flex">
              ...
              <div className="mb-5">
                <div className="border-b border-[#ebedf2] dark:border-[#1b2e4b]">
                  <div className="flex items-start justify-between py-3">
                    <div className="flex-none ltr:mr-4 rtl:ml-4">
                      <Image
                        src="/assets/images/template/card-americanexpress.svg"
                        alt="img"
                      />
                    </div>
                    <h6 className="text-[15px] font-bold text-[#515365] dark:text-white-dark">
                ...
                <div className="border-b border-[#ebedf2] dark:border-[#1b2e4b]">
                  <div className="flex items-start justify-between py-3">
                    <div className="flex-none ltr:mr-4 rtl:ml-4">
                      <Image
                        src="/assets/images/template/card-mastercard.svg"
                        alt="img"
                      />
                    </div>
                    <h6 className="text-[15px] font-bold text-[#515365] dark:text-white-dark">
                ...
                <div>
                  <div className="flex items-start justify-between py-3">
                    <div className="flex-none ltr:mr-4 rtl:ml-4">
                      <Image
                        src="/assets/images/template/card-visa.svg"
                        alt="img"
                      />
                    </div>
                    <h6 className="text-[15px] font-bold text-[#515365] dark:text-white-dark">
                  ...
                  <label className="inline-flex cursor-pointer">
                    ...
                    <span>
                      <Image
                        ...
                        height="68"
                        alt="settings-dark"
                        src="/assets/images/template/settings-light.svg"
                      />
                    </span>
                  </label>
                </div>
                ...
                <label className="inline-flex cursor-pointer">
                  ...
                  <span>
                    <Image
                      ...
                      height="68"
                      alt="settings-light"
                      src="/assets/images/template/settings-dark.svg"
                    />
                  </span>
                </label>
              </div>
