  ...
  return (
    ...
    <div className="flex flex-col rounded-md border border-white-light dark:border-[#1b2e4b]">
        ...
        >
          <div className="mb-5">
            <div className="flex flex-col rounded-md border border-white-light dark:border-[#1b2e4b]">
              <div className="border-b border-white-light px-4 py-2.5 dark:border-[#1b2e4b]">
                Cras justo odio
              </div>
              <div className="border-b border-white-light px-4 py-2.5 dark:border-[#1b2e4b]">
                Dapibus ac facilisis in
              </div>
              <div className="border-b border-white-light bg-primary px-4 py-2.5 text-white shadow-[0_1px_15px_1px_rgba(67,97,238,0.15)] dark:border-[#1b2e4b]">
                Morbi leo risus
              </div>
              <div className="border-b border-white-light px-4 py-2.5 dark:border-[#1b2e4b]">
        ...
        >
          <div className="mb-5">
            <div className="flex flex-col rounded-md border border-white-light dark:border-[#1b2e4b]">
              <Link
                href="#"
                className="border-b border-white-light px-4 py-2.5 hover:bg-[#eee] dark:border-[#1b2e4b] dark:hover:bg-[#eee]/10"
              >
                Cras justo odio
              </Link>
              <Link
              ...
              <Link
                href="#"
                className="px-4 py-2.5 hover:bg-[#eee] dark:hover:bg-[#eee]/10"
              >
                Vestibulum at eros
              </Link>
            </div>
            ...
            <div className="flex flex-col rounded-md border border-white-light dark:border-[#1b2e4b]">
              <div className="flex space-x-4 border-b border-white-light px-4 py-2.5 hover:bg-[#eee] rtl:space-x-reverse dark:border-[#1b2e4b] dark:hover:bg-[#eee]/10">
                ...
                <label htmlFor="tack_checkbox1" className="mb-0 cursor-pointer">
                  ...
                  displaying simple.
                  <span className="badge my-auto bg-secondary hover:top-0 ltr:ml-3 rtl:mr-3">
                    Project
                  </span>
                </label>
              </div>
              <div className="group flex space-x-4 border-b border-white-light bg-primary px-4 py-2.5 text-white shadow-[0_1px_15px_1px_rgba(67,97,238,0.15)] hover:bg-[#eee] hover:text-black rtl:space-x-reverse dark:border-[#1b2e4b] dark:hover:bg-[#eee]/10 dark:hover:text-white">
                <input
                  id="tack_checkbox2"
                  type="checkbox"
                  className="form-checkbox checked:border-white-light dark:checked:border-[#253B5C]"
                />
                <label htmlFor="tack_checkbox2" className="mb-0 cursor-pointer">
                  List groups are a flexible and powerful component for
                  displaying simple.
                  <span className="badge my-auto bg-info hover:top-0 ltr:ml-3 rtl:mr-3">
                    Urgent
                  </span>
                </label>
              </div>
              <div className="flex space-x-4 px-4 py-2.5 hover:bg-[#eee] rtl:space-x-reverse dark:hover:bg-[#eee]/10">
                ...
                <label htmlFor="tack_checkbox3" className="mb-0 cursor-pointer">
                  List groups are a flexible and powerful component for
                  displaying simple.
                  <span className="badge my-auto bg-success hover:top-0 ltr:ml-3 rtl:mr-3">
                    Success
                  </span>
                </label>
              </div>
