...
import ComponentsMediaObjectDropdown from './ComponentsMediaObjectDropdown';
  ...
  return (
    ...
    <div className="flex">
        <div className="ltr:mr-4 rtl:ml-4">
            <Image src="/assets/images/template/profile-5.jpeg" alt="img" className="w-16 h-16 rounded" />
        </div>
    ...
    <div className="flex mb-5">
        <div className="ltr:mr-4 rtl:ml-4">
            <Image src="/assets/images/template/profile-5.jpeg" alt="img" className="w-14 h-14 rounded" />
        </div>
        <div className="flex-1">
            <h4 className="font-semibold text-lg mb-2 text-primary">Heading</h4>
            <p className="media-text">
                ...
                <ul className="flex space-x-4 font-bold rtl:space-x-reverse">
                  ...
                  <li>
                    <button
                      ...
                      className="flex items-center hover:text-primary"
                    >
                      <IconPencil className="h-3.5 w-3.5 ltr:mr-1 rtl:ml-1" />{" "}
                      Edit
                    </button>
                  </li>
                  <li>
