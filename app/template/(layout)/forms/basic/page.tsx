  ...
  return (
    ...
    <input type="range" className="w-full py-2.5" min="0" max="100" />
        ...
        >
          <div className="mb-5">
            <form>
              <input type="range" className="w-full py-2.5 bg-primary" min="0" max="100" />
            </form>
          </div>
        </PanelCodeHighlight>
          ...
          <div className="mb-5">
            <form>
              <div>
                ...
                />
                <span className="badge bg-primary text-xs hover:top-0">
                  I am the helper text.
                </span>
              </div>
            </form>
            ...
            <form>
              <div>
                <input
                  ...
                  className="form-input mb-2"
                />
                <span className="badge block bg-primary text-xs hover:top-0">
                  I am the helper text.
                </span>
              </div>
            </form>
          ...
          <div className="mb-5">
            <form>
              <div>
                ...
                />
                <span className="text-xs text-white-dark ltr:pl-2 rtl:pr-2">
                  Min 8-20 char
                </span>
              </div>
            </form>
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                <div>
                  ...
                  <input
                    ...
                    className="form-input-lg form-input"
                  />
                </div>
                <div>
                  <label htmlFor="inputDefault">Default Input</label>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="form-input-sm form-input"
                  />
                </div>
              </div>
            </form>
            ...
            <form className="space-y-5">
              <div className="items-center justify-between gap-5 sm:flex md:gap-20">
                ...
                <input
                  ...
                  type="email"
                  placeholder="name@example.com"
                  className="form-input py-2.5 text-base"
                />
              </div>
              <div className="items-center justify-between gap-5 sm:flex md:gap-20">
                <label htmlFor="hrDefaultinput">Email</label>
            ...
            <form>
              <div>
                <input
                  ...
                  className="form-input disabled:pointer-events-none"
                  readOnly
                />
              </div>
            </form>
          ...
          <div className="mb-5">
            <form className="space-y-5">
              ...
              <div>
                ...
                <select
                  id="disSelect"
                  className="form-select text-white-dark disabled:pointer-events-none disabled:bg-[#eee] dark:disabled:bg-[#1b2e4b]"
                  disabled
                >
                  <option>Open this select menu</option>
                  <option>One</option>
              ...
              <button
                type="submit"
                className="btn btn-primary !mt-6 disabled:pointer-events-none disabled:opacity-60"
                disabled
              >
                Submit
              </button>
            ...
            <form>
              <div>
                <select
                  size={4}
                  multiple
                  className="form-multiselect !bg-none text-white-dark"
                >
                  {/* <option>Open this select menu</option> */}
                  <option>One</option>
                  <option>Two</option>
