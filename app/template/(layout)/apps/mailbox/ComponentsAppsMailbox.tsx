  ...
  const [mailList, setMailList] = useState([
    {
      ...
      description: `
                              ...
                              <div class="gallery text-center">
                                  <img alt="image-gallery" src="${withBasePath(
                                    "/assets/images/template/carousel3.jpeg"
                                  )}" class="mb-4 mt-4" style="width: 250px; height: 180px;" />
                                  <img alt="image-gallery" src="${withBasePath(
                                    "/assets/images/template/carousel2.jpeg"
                                  )}" class="mb-4 mt-4" style="width: 250px; height: 180px;" />
                                  <img alt="image-gallery" src="${withBasePath(
                                    "/assets/images/template/carousel1.jpeg"
                                  )}" class="mb-4 mt-4" style="width: 250px; height: 180px;" />
                              </div>
            ...
            <div>
              <div className="flex flex-wrap items-center justify-between p-4">
                <div className="flex items-center">
                  ...
                  <h4 className="text-base font-medium ltr:mr-2 rtl:ml-2 md:text-lg">
                    {selectedMail.title}
                  </h4>
              ...
              <div className="relative p-4">
                <div className="flex flex-wrap">
                  <div className="flex-shrink-0 ltr:mr-2 rtl:ml-2">
                    {selectedMail.path ? (
                      <Image
                        src={`/assets/images/profile/${selectedMail.path}`}
                  ...
                  <div className="flex-1 ltr:mr-2 rtl:ml-2">
                    ...
                    <div className="flex items-center text-white-dark">
                      ...
                      <div className="dropdown">
                        ...
                        >
                          <ul className="sm:w-56 bg-white dark:bg-black-7 rounded-lg shadow-lg">
                            <li>
