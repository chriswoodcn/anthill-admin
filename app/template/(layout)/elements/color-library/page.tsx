      ...
      <div className="space-y-8 pt-5">
        ...
        <div>
          <div className="mb-5 w-fit">
            <h5 className="rounded bg-success/20 px-3 py-1 text-base font-semibold text-success">
              Main Colors
            </h5>
          </div>
          <div className="mb-5">
        ...
        <div>
          <div className="mb-5 w-fit">
            <h5 className="rounded bg-success/20 px-3 py-1 text-sm font-semibold text-success sm:text-base">
              More Colors
            </h5>
          </div>
          <div>
