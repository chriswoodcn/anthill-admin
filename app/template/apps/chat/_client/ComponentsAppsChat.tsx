...
const ComponentsAppsChat = () => {
  ...
  const isDark = useAppSelector(
    (state: RootState) =>
      state.adminSetting.theme === "dark" || state.adminSetting.isDarkMode
  );
                      ...
                      <div className="flex-1">
                        <div className="flex items-center">
                          <div className="relative flex-shrink-0">
                            <Image
                              src={`/assets/images/profile/${person.path}`}
                              className="h-12 w-12 rounded-full object-cover"
                              alt=""
                            />
                            {person.active && (
              ...
              <div className="flex items-center justify-between p-4">
                <div className="flex items-center space-x-2 rtl:space-x-reverse">
                  ...
                  <div className="relative flex-none">
                    <Image
                      src={`/assets/images/profile/${selectedUser.path}`}
                          ...
                          <div key={index}>
                            ...
                            >
                              ...
                              >
                                {selectedUser.userId === message.fromUserId ? (
                                  <Image
                                    src={`/assets/images/profile/${loginUser.path}`}
              ...
              <div className="absolute bottom-0 left-0 w-full p-4">
                <div className="w-full items-center space-x-3 rtl:space-x-reverse sm:flex">
                  <div className="relative flex-1">
                    ...
                    <button
                      type="button"
                      className="absolute top-1/2 -translate-y-1/2 hover:text-primary ltr:left-4 rtl:right-4"
                    >
                      <IconMoodSmile />
                    </button>
                    <button
